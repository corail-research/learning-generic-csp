...
def add_neurosat_options(parser):
    ...
    parser.add_argument('--n_rounds', action='store', dest='n_rounds', type=int, default=26, help='Number of rounds of message passing')
    ...
    parser.add_argument('--lr_end', action='store', dest='lr_end', type=float, default=0.0001, help='Learning rate end')
